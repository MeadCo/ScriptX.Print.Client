...
; (function (name, definition) {
    ...
    //
    function funcPrintHtmlAtServer(contentType, content, htmlPrintSettings, fnDone, fnProgress, data) {
    ...
    function printHtmlAtServer(contentType, content, htmlPrintSettings, fnDone, fnProgress, data) {
        ...
        setTimeout(funcPrintHtmlAtServer(contentType, content, htmlPrintSettings, fnDone, fnProgress, data), timeoutToJobStart);
