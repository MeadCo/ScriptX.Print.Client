...
```javascript
<script src="https://cdn.jsdelivr.net/npm/scriptxprint-html@1.7.0-beta05/dist/meadco-scriptxservices.min.js"></script>
```

Or, for print only to cloud/on premise services,

```javascript
<script src="https://cdn.jsdelivr.net/npm/scriptxprint-html@1.7.0-beta05/dist/meadco-scriptxservicesprint.min.js"></script>
```
