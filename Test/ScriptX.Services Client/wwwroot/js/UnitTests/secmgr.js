...
QUnit.test("Namespace basics", function (assert) {
    ...
    assert.strictEqual(api.version, "1.10.1.0", "Correct version");
    ...
    assert.throws(
        () => { var l = api.License; },
        function (err) { 
            return err.message === "MeadCo.ScriptX.Licensing.getSubscriptionFromServer: MeadCo.ScriptX.Print : server connection is not defined.";
        },
